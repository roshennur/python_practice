...
def print_chessboard(board):
    #This contains 64 squares with chess pieces and color of each sq.
    squares = []
    #First a8 starts with white color
    is_white_square = True
    for y in '87654321':
        for x in 'abcdefgh':
            #print(x,y, is_white_square) #DEBUG: Show coordinates
            #Checks if theres chess piece in certain sq.
            ...
            #Toggle the color of next sq in row
            is_white_square = not is_white_square
        #Toggle the color of next sq in column
        is_white_square = not is_white_square
    #Destructure squares list & place values in it into placeholder in BOARD_TEMPLATE
